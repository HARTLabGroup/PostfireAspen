...
We also downloaded 30 m rasters of existing vegetation type in ca. 2016 from LANDFIRE [@landfire2016ExistingVegetationType]

```{r DL_EVT}
## Download EVT (if not already downloaded)
if(!dir.exists( here("Data", "Spatial",  "LANDFIRE", "LF2016_EVT_200_CONUS"))){
  dir.create(here("Data", "Spatial", "LANDFIRE"))
  temp <- here("Data", "Spatial", "LANDFIRE", "LF2016_EVT_200_CONUS.zip")
  download.file("https://www.landfire.gov/data-downloads/US_200/LF2016_EVT_200_CONUS.zip", temp, mode="wb")
